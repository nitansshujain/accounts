...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public void createAccount(CustomerDto customerDto) {
        ...
        Optional<Customer> optionalCustomer = customerRepository.findByMobileNumber(customerDto.getMobileNumber()); // why to getMobileNumber through customerDto, not customer
...
//        customer.setCreatedBy("Anonymous");
    ...
    /**
     * @param customer - Customer Object who opens the new Account
...
//        newAccount.setCreatedBy("Anonymous");
    ...
    public boolean updateAccount(CustomerDto customerDto) {
        ...
        if(accountsDto != null ){
            ...
            accounts = accountsRepository.save(accounts); // Doubtful -> We have to initialise accounts again otherwise fields(updated_at, updated_by) will not get updated inside the table in the DB.
